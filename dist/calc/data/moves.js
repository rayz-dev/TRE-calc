...
var TRE_PATCH = {
    ...
    Dive: { bp: 110, category: 'Special', makesContact: false },
    'Dragon Rage': { bp: 70, category: 'Physical', makesContact: true, secondaries: true },
    'Dual Wingbeat': { bp: 50 },
    Eternabeam: { bp: 150, recoil: [1, 2] },
    Fissure: { bp: 130, self: { boosts: { atk: -1, def: -1 } } },
    Flash: { bp: 50, category: 'Special', type: 'Electric', drain: [3, 4] },
    ...
    'Hydro Cannon': { bp: 105 },
    'Hyper Beam': { bp: 160 },
    'Ice Burn': { bp: 130, recoil: [1, 3] },
    'Light of Ruin': { recoil: [1, 3] },
    'Magical Leaf': { bp: 75 },
    Megadrain: { bp: 50 },
    'Mud-Slap': { bp: 30, category: 'Physical' },
    Octazooka: { bp: 100, isPulse: true },
    'Ominous Wind': { bp: 75 },
    'Origin Pulse': { bp: 120 },
    'Poison Tail': { bp: 90 },
    'Prismatic Laser': { bp: 175 },
    'Razor Wind': { bp: 130 },
    'Roar of Time': { bp: 180, self: { boosts: { def: -1, spd: -1, spe: -1 } } },
    'Rock Smash': { bp: 65 },
    'Rock Wrecker': { bp: 165 },
    ...
    'Smart Strike': { bp: 75 },
    'Spacial Rend': { bp: 115 },
    'Steel Beam': { recoil: [1, 2], mindBlownRecoil: false },
...
var SS = (0, util_1.extend)(true, {}, SM, SS_PATCH, TRE_PATCH, SV_PATCH);
var LGPE_MOVES = [
    'Baddy Bad',
    'Bouncy Bubble',
    'Buzzy Buzz',
